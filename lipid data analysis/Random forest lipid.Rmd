...
```{r}
plot(gbm.ROC_test,col ="darkred",main="Random Forest 1- ROC curve",
     col.lab="black", cex.lab=1.5)
text(x = 0.6445764,y =0.8701577,label="AUC:0.63",cex=1)

plot(gbm.ROC_val,col ="darkgreen",add=T)
text(x = 0.9274354,y = 0.4076923,label="AUC:0.67",cex=1)
